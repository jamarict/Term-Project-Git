...
tempBoard = [[Forest(0,0), Field(0, 1), Field(0,2), Mountain(0,3), Field(0,4), Forest(0,5), Field(0,6), Field(0,7), Field(0,8), Field(0,9), Field(0,10)],
             ...
             [Field(5,0), Capital(5,1,Player("Jamari")), Field(5,2), Field(5,3), Forest(5,4), Mountain(5,5), Mountain(5,6), Forest(5,7),Field(5,8), Forest(5,9), Mountain(5, 10)],
             ...
             [Field(9,0), Field(9,1), Forest(9,2), Field(9,3), Forest(9,4), Forest(9,5), Forest(9,6), Field(9,7), Field(9,8), Capital(9,9,Player("Gabriel")), Mountain(9,10)],
