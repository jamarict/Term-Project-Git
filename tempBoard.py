...
tempBoard = [[Forest(0,0), Field(0, 1), Field(0,2), Mountain(0,3), Field(0,4), Forest(0,5), Field(0,6), Field(0,7), Field(0,8), Field(0,9), Field(0,10)],
             ...
             [Forest(2,0), City(2,1), Forest(2,2), Field(2,3), Forest(2,4), Village(2,5), Forest(2,6), Forest(2,7), Field(2,8), Forest(2,9), Field(2,10)],
             ...
             [Mountain(7,0), Forest(7,1), Field(7,2), Field(7,3), Mountain(7,5), Forest(7,5), Village(7,6), Field(7,7), Field(7,8), City(7,9), Field(7,10)],
